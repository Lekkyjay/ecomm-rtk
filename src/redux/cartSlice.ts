...
export const selectAllCarts = (state: RootState) => state.cart.carts
export const selectCartItemsCount = (state: RootState) => state.cart.itemsCount
export const selectCartMessageStatus = (state: RootState) => state.cart.isCartMessageOn
