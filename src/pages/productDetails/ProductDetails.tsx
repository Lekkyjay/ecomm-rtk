...
import { addToCart, selectCartMessageStatus, setCartMessageOff, setCartMessageOn } from '../../redux/cartSlice'
import { useAppDispatch, useAppSelector } from '../../redux/hooks'
import { fetchAsyncProductSingle, selectProductSingle, selectSingleProductStatus } from '../../redux/productSlice'
...
export default function ProductDetails() {
  ...
  const product = useAppSelector(selectProductSingle)
  const productSingleStatus = useAppSelector(selectSingleProductStatus)
  const [quantity, setQuantity] = useState(1)
  const cartMessageStatus = useAppSelector(selectCartMessageStatus)
